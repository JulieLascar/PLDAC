...
dico_hash_candidats=dict() # dico : candidat--> liste des hastags
...
df.plot(kind='bar',figsize = (15,15),title='Les hashtags prépondérants du 1er au 15 avril 2017')
plt.savefig("Histogramme_hashtag1.png")
